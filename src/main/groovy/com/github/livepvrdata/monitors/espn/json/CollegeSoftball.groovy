...
class CollegeSoftball extends Monitor {
	static private final String SPORT = 'softball'
	static private final String LEAGUE = 'college-softball'
	static String getNormalizedTitle() { 'College Softball' }
	static Event[] getEventsForDate(long date) throws IOException {	Monitor.getEventsForDate(SPORT, LEAGUE, date) }

	CollegeSoftball(String desc, long date) {
		super(desc, date, SPORT, LEAGUE)
	}

	CollegeSoftball(String[] teams, long date) {
