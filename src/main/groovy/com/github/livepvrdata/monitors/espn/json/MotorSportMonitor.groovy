...
abstract class MotorSportMonitor extends EventMonitor {
	...
	static final Event[] getFeed(String sport, String league) throws IOException {
		...
		new Event[0]
//		try {
//			return EventCache.getCache(key, new URL(String.format(FEED_URL, sport, league)), MotorSportMonitor.class.getDeclaredMethod("parseFeed", [String.class] as Class[]), null).read();
